...
--%><%@ page language="java" contentType="text/html; charset=UTF-8" %><%@ page isELIgnored="false" 
...
%><%@ taglib prefix="tiles-el" uri="/WEB-INF/tlds/struts-tiles-el.tld" 
...
<%--
<%@ taglib prefix="cfn" uri="http://www.dlsciences.org/cfn" %>
--%>